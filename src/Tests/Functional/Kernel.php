...
{
    protected string $bundlePrefix = 'MenuBundle';
    ...
    {
        return array_merge(parent::registerBundles(), [new \Evrinoma\DtoBundle\EvrinomaDtoBundle(), new \Evrinoma\MenuBundle\EvrinomaMenuBundle()]);
    }
