...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->scalarNode('preserve_dto')->cannotBeEmpty()->defaultValue(EvrinomaMenuExtension::DTO_PRESERVE_BASE_MENU)->info('This option is used for preserve_dto class override')->end()
